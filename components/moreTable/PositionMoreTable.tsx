                ...
                <div className="overflow-x-auto relative table-wrapper  mb-16"  style={{ overflowX: 'auto', scrollbarWidth: 'none', msOverflowStyle: 'none', position: 'relative' }}>
                  <table className="w-full text-sm text-left   border border-gray-800 " >
                          ...
                          <tr className="rounded-t-lg">
                              <th style={{ width: '200px' }} className="rounded-tl-lg"><TableHeaderCell title="Collateral" infoText="The token(s) that borrowers must lock in order to borrow funds." /></th>
                              ...
                              <th style={{ width: '200px' }}> <div className='flex justify-start'><TableHeaderCell title="1D Interest" infoText=""/> </div></th>
                              <th style={{ width: '200px' }}><div className='flex justify-start'><TableHeaderCell title="Vault Listing" infoText=""/></div></th>
                          ...
                          {tableData.map((item, index, arr) => (
                              <tr key={index} 
                                ...
                                <td className="py-4  items-center h-full ">
                                  ...
                                  <td className="py-4 px-4 items-center flex  ">
                                  ...
                                  <td className="py-4 px-4  items-center justify-start h-full ">
                                      <div className='flex gap-1 justify-start' > <FormatPourcentage value={item.unsecuredAPY} ></FormatPourcentage> </div>
                                  </td>
                                  ...
                                  <td className="py-4 px-4  items-center justify-end h-full">
