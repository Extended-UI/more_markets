...
<div className="overflow-x-auto relative rounded-[15px] mb-16"  style={{ overflowX: 'auto', scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
        ...
        <table className="w-full text-sm text-left   border border-gray-800 " >
                ...
                <tr className="rounded-t-lg">
                    ...
                    <th style={{ width: '200px' }}> <div className='flex justify-start'><TableHeaderCell title="1D Interest" /> </div></th>
                    <th style={{ width: '200px' }}><div className='flex justify-start'><TableHeaderCell title="Vault Listing" /></div></th>
