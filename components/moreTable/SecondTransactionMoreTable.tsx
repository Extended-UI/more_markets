        ...
        >
          <tr className="rounded-t-lg">
            <th style={{ width: "200px" }} className="rounded-tl-lg">
              <TableHeaderCell title="Date & Time" infoText="" />
            </th>
            <th style={{ width: "200px" }}>
              <div className="flex justify-start">
                <TableHeaderCell title="Liquidation Wallet" infoText="" />
              </div>
            </th>
            <th style={{ width: "200px" }}>
              <div className="flex justify-start">
                <TableHeaderCell title="Liquidator" infoText="" />
              </div>
            </th>
            <th style={{ width: "200px" }}>
              <div className="flex justify-start">
                <TableHeaderCell title="Hash" infoText="" />
              </div>
            </th>
            <th style={{ width: "200px" }}>
              {" "}
          ...
          {tableData.map((item, index, arr) => (
            ...
            >
              <td className="py-4 px-6 items-center h-full">
                <div className="flex gap-1 justify-start">{item.time}</div>
              </td>
