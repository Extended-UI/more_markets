  ...
  return (
    <div className='flex w-full flex-col overflow-visible'>
        <div className="flex  w-full overflow-x-auto" style={{
            ...
            <InfoDetailGrey title='Total Deposit' className="flex-1 m-2  min-w-[200px]"><span className='text-[#888888] font-[600] ' >$</span><span className='text-white'>1.94M</span> </InfoDetailGrey>
            <InfoDetailGrey title='Available Liquidity' className="flex-1 m-2  min-w-[200px]"><span className='text-[#888888] font-[600] ' >$</span><span className='text-white'>194.7k</span> </InfoDetailGrey>
            <InfoDetailGrey title='Total 7D APY' className="flex-1 m-2  min-w-[200px]"><span className='text-white' >17.1</span><span className='text-[#888888] font-[600] '>%</span></InfoDetailGrey>
            <InfoDetailGrey title='Utilization' className="flex-1 m-2  min-w-[200px]"><span className='text-white' >89.82</span><span className='text-[#888888] font-[600] '>%</span></InfoDetailGrey>
        </div>
