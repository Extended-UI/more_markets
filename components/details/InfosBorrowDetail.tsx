  ...
  return (
    <div className='flex w-full flex-col overflow-visible'>
        <div className="flex w-full overflow-x-auto" style={{
            ...
            width: 'calc(100% + 2rem)', position: 'relative', left: '0',  overflow: "visible",
        }}>
            <InfoDetailGrey title='Total Deposit' infoText = "The total amount of tokens that have been deposited into the vault and made available to borrowers for loans." className="flex-1 m-2 min-w-[180px]"><span className='text-[#888888] font-[600] ' >$</span><span className=''>1.94M</span> </InfoDetailGrey>
            <InfoDetailGrey title='Total Borrow' infoText="The total amount of tokens currently lent in the given market." className="flex-1 m-2 min-w-[220px]"><span className='text-[#888888] font-[600] ' ></span><span className=''>194.7M</span><span className='text-secondary text-[14px] ml-4'>(89.2%)</span> </InfoDetailGrey>
