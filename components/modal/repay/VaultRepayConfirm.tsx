...
const VaultRepayConfirm: React.FC<Props> = ({ title, token, balance, apy, ltv, totalRepay, totalTokenAmount, processDone, closeModal, amount }) => {
  ...
  return (
    <div className='more-bg-secondary h-full rounded-[12px] pt-14 pb-8'>      
        ...
        <div className='more-bg-primary rounded-[5px] mb-5 py-8 px-8 mx-5 '> 
        ...
        <div className="flex justify-end py-5  rounded-b-[20px] ">
          <div className='mr-5'><MoreButton className='text-xl  py-4' text="Done" onClick={closeModal} color="secondary" /></div>
        </div>              
    </div>
  );
};
