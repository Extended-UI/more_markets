...
const VaultAddConfirm: React.FC<Props> = ({ title, token, balance, apy, ltv, totalAdd, totalTokenAmount, processDone, closeModal, amount }) => {
  ...
  return (
    <div className='more-bg-secondary h-full rounded-[12px]'>      
        ...
        <div className='more-bg-primary text-l rounded-[5px] mb-5 py-8 px-8 mx-5 '> 
            Add 0.50 USDC from USDmax
        </div>        
        ...
        <div className="flex justify-end py-5  rounded-b-[20px] ">
          <div className='mr-5'><MoreButton className='text-xl  py-2' text="Done" onClick={closeModal} color="secondary" /></div>
        </div>              
    </div>
  );
};

export default VaultAddConfirm;
