...
//max={3}
  ...
  return (
    <>
      <div className="mockup-window border-base-300 border"><MoreGraphicsV2  datasets={datasets} labelsX={labelsX} comment='Learn MORE about ratings and how to get rated here.'></MoreGraphicsV2></div>
    </>
  )
}
